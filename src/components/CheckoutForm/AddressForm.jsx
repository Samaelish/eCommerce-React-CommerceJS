      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit((data) => test({ ...data, shippingCountry, shippingSubdivision, shippingOption }))}>
          <Grid container spacing={3}>
            ...
            <FormInput required name="address1" label="Адрес" />
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>Детали доставки</InputLabel>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <Button component={Link} variant="outlined" to="/cart">Вернуться к корзине</Button>
            <Button type="submit" variant="contained" color="primary">Оплата</Button>
          </div>
        </form>
      </FormProvider>
    </>
